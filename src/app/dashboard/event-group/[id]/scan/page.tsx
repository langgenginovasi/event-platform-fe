...
export default function WorkspaceScanPage() {
  ...
  const handleCheckIn = async (qrCode: string) => {
    ...
    console.log("Scanning payload:", { eventGroupId, selectedEventId, scanType, qrCode });
      ...
      <GlassCard className="p-5 space-y-6 relative overflow-hidden">
        ...
        <div className="space-y-3 relative z-10">
          <div className="flex items-center gap-2">
            <span className="flex items-center justify-center w-6 h-6 rounded-full bg-[var(--brand-primary)] text-white text-xs font-bold shadow-md shadow-[var(--brand-primary)]/20">1</span>
        ...
        <div className="space-y-3 relative z-10">
          <div className="flex items-center gap-2">
            <span className={cn("flex items-center justify-center w-6 h-6 rounded-full text-xs font-bold text-white transition-all shadow-md", selectedEventId ? "bg-[var(--brand-primary)] shadow-[var(--brand-primary)]/20" : "bg-gray-300 shadow-none")}>2</span>
            <h2 className={cn("font-semibold transition-colors", selectedEventId ? "text-gray-800" : "text-gray-400")}>Pilih Tipe Absensi</h2>
          </div>
